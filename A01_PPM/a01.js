...
function rotate(){
    ...
    for(var i = 0; i < image_data.data.length; i+= 4){
        ...
        let arr_pos = (Math.round(xy_rotated[0]) + Math.round(xy_rotated[1]) * canvas.width) * 4;
        ...
        // // the simplest trick To avoid moire
        new_image_data.data[arr_pos - 4] = ppm_image_data.data[i + 0];
        new_image_data.data[arr_pos - 3] = ppm_image_data.data[i + 1];
        new_image_data.data[arr_pos - 2] = ppm_image_data.data[i + 2];
        new_image_data.data[arr_pos - 1] = ppm_image_data.data[i + 3];
    }
